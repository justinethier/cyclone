...
Cyclone is the first compiler written entirely in the latest R<sup>7</sup>RS Scheme language standard. A large portion of the language is supported and the goal is for Cyclone to allow the practical development of applications using R<sup>7</sup>RS.
