...
[`match-lambda*`](api/scheme/cyclone/match.md#match-lambda-1)
[`match-lambda`](api/scheme/cyclone/match.md#match-lambda)
[`match-let*`](api/scheme/cyclone/match.md#match-let-1)
[`match-let`](api/scheme/cyclone/match.md#match-let)
[`match-letrec`](api/scheme/cyclone/match.md#match-letrec)
[`match`](api/scheme/cyclone/match.md#match)
